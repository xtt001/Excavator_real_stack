"""Build the terminal B1.4/G5.1/E04 SimVerify M5 package."""
...
from testbed.simverify.m5_decision_v3 import build_m5_decision_v3


def main() -> None:
    parser = argparse.ArgumentParser(prog="tb-build-simverify-m5-v3")

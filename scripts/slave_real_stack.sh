...
BUCKET_QUATERNION_OFFSET_RAD="${EXCAVATOR_BUCKET_QUATERNION_OFFSET_RAD:--0.406006669412}"
...
Common environment overrides:
  ...
  EXCAVATOR_BUCKET_QUATERNION_OFFSET_RAD=-0.406006669412
...
start_stack() {
  ...
  prepare_start
  log "bucket quaternion policy offset rad=${BUCKET_QUATERNION_OFFSET_RAD}"
  ...
  export EXCAVATOR_BUCKET_QUATERNION_OFFSET_RAD="${BUCKET_QUATERNION_OFFSET_RAD}"
